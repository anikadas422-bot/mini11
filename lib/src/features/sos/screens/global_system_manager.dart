                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(l10n.sosSentWaiting, style: const TextStyle(color: Colors.white70, fontSize: 13)),
                            ],
                          ),
                        ),
                      ],
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(l10n.helpOnTheWay, style: const TextStyle(color: Colors.white, fontSize: 13)),
                              ],
                            ),
                          ),
                          Text(
                        ...
                        Padding(
                          ...
                          child: SizedBox(
                            ...
                            child: ElevatedButton(
                              ...
                              child: Text(l10n.acceptSos, style: const TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 16)),
                            ),
                          ),
                        )
                     ],
